...
@interface AddEmployeeTableViewController ()<UITextFieldDelegate>
...
-(BOOL)uniqueEntityExistsWithEnityName {
    ...
    if (!matches) {
        ...
        addEmployee.employeeShop = _employeeShop.text;
        addEmployee.employeeFirstName = _employeeFirstName.text;
        addEmployee.employeeLastName = _employeeLastName.text;
        addEmployee.employeePhoneNumber = _employeePhoneNumber.text;
        addEmployee.employeeSecondPhoneNumber = _employeeSecondPhoneNumber.text;
        addEmployee.employeeEmail = _employeeEmail.text;
        addEmployee.employeeDateOfBirth = _datePicker.date;
        addEmployee.employeeNote = _employeeNoteView.text;
